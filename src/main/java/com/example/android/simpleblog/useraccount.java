...
public class useraccount extends Fragment {
    ...
    private Button edit_button,chat_button;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chat_button = mView.findViewById(R.id.chat_button);
...
/*
        ...
        mProfileFriendsCount = mView.findViewById(R.id.profile_totalFriends);
        mProfileSendReqBtn =  mView.findViewById(R.id.profile_send_req_btn);
        mDeclineBtn =  mView.findViewById(R.id.profile_decline_btn);
