                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (task.getResult().exists()) {
                            ...
                            Glide.with(SetupActivity.this).setDefaultRequestOptions(placeholderRequest).load(image).thumbnail(
                                    Glide.with(SetupActivity.this).load(imagethumb)).into(setupImage);
